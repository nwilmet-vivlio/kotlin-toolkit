...
internal object CareClient {
    ...
    data class Context(
        ...
        companion object {
            ...
            fun fromDRMContext(drmContext: Any): Context =
                with(Class.forName("com.vivlio.care.lib.DRMContext")) {
        ...
        fun toDRMContext(): Any =
            Class.forName("com.vivlio.care.lib.DRMContext")
    ...
    private val klass: Class<*> by lazy {
        Class.forName("com.vivlio.care.lib.Lcp")
    }
    ...
    fun decrypt(context: Context, encryptedData: ByteArray): ByteArray =
        try {
            klass
                .getMethod("decrypt", Class.forName("com.vivlio.care.lib.DRMContext"), ByteArray::class.java)
    ...
    private fun mapException(e: Throwable): LcpException {
        ...
        val drmExceptionClass = Class.forName("com.vivlio.care.lib.DRMException")
        ...
        val errorCode = Class
            .forName("com.vivlio.care.lib.DRMError")
            .getMethod("getCode")
